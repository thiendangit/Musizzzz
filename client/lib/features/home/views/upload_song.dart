...
class _UploadSongPageState extends ConsumerState<UploadSongPage> {
  ...
  Widget build(BuildContext context) {
    final isLoading = ref.watch(
        homeViewModelProvider.select((state) => state?.isLoading == true));
        ...
        actions: [
          IconButton(
            onPressed: () async {
              ...
              final homeRepo = ref.read(homeViewModelProvider.notifier);
              final result = await homeRepo.uploadSong(SongCreate(
