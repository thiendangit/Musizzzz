...
part of 'current_song_notifer.dart';
...
String _$currentSongNotifierHash() =>
    r'8516fe2e289c610a4934122f8420ec85d9c2e6ce';

/// See also [CurrentSongNotifier].
@ProviderFor(CurrentSongNotifier)
final currentSongNotifierProvider =
    NotifierProvider<CurrentSongNotifier, Song?>.internal(
...
typedef _$CurrentSongNotifier = Notifier<Song?>;
